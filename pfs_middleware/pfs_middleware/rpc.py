...
allow_read_only = {
    ...
    "Server.GetObjectReq",
    "Server.GetStatPathRequest",
    "Server.GetStatRequest",
    "Server.GetXAttrPathRequest",
    "Server.GetXAttrRequest",
    "Server.HeadReq",
    "Server.IsAccountBimodalReq",
    "Server.ListXAttrPathRequest",
    "Server.ListXAttrRequest",
    "Server.LookupPathRequest",
    "Server.LookupRequest",
    "Server.MountByAccountNameRequest",
    "Server.MountByVolumeNameRequest",
    "Server.PingReq",
    "Server.ReadSymlinkPathRequest",
    "Server.ReadSymlinkRequest",
    "Server.ReaddirByLocRequest",
    "Server.ReaddirPlusByLocRequest",
    "Server.ReaddirPlusRequest",
    "Server.ReaddirRequest",
    "Server.StatVFSRequest",
    "Server.TypeRequest",
}

allow_read_write = {
    "Server.ChmodPathRequest",
    "Server.ChmodRequest",
    "Server.ChownPathRequest",
    "Server.ChownRequest",
    "Server.CoalesceReq",
    ...
    "Server.LookupPathRequest",
    "Server.LookupRequest",
    "Server.MiddlewareMkdirReq",
    "Server.MiddlewarePostReq",
    "Server.MkdirPathRequest",
    "Server.MkdirRequest",
    "Server.MountByAccountNameRequest",
    "Server.MountByVolumeNameRequest",
    "Server.PingReq",
    "Server.PutCompleteReq",
    "Server.PutContainerReq",
    "Server.PutLocationReq",
    "Server.ReadSymlinkPathRequest",
    "Server.ReadSymlinkRequest",
    "Server.ReaddirByLocRequest",
    "Server.ReaddirPlusByLocRequest",
    "Server.ReaddirPlusRequest",
    "Server.ReaddirRequest",
    "Server.ReleaseLeaseReq",
    "Server.RemoveXAttrPathRequest",
    "Server.RemoveXAttrRequest",
    "Server.RenamePathRequest",
    "Server.RenameRequest",
    "Server.RenewLeaseReq",
    "Server.ResizeRequest",
    "Server.SetTimePathRequest",
    "Server.SetTimeRequest",
    "Server.SetXAttrPathRequest",
    "Server.SetXAttrRequest",
    "Server.SetstatRequest",
    "Server.StatVFSRequest",
    "Server.SymlinkPathRequest",
    "Server.SymlinkRequest",
    "Server.TypeRequest",
